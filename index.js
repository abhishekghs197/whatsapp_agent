...
async function startBot() {
    ...
    sock.ev.on('connection.update', (update) => {
        ...
        if (connection === 'open') console.log('✅ CODERABHI AI IS ONLINE!');
        if (connection === 'close') {
    ...
    sock.ev.on('messages.upsert', async (m) => {
        ...
        if (orderStates[sender]?.step === 'WAITING_FOR_ADDRESS') {
            ...
            // Match the exact format of your CoderAbhi Admin Panel
            const coderAbhiOrder = {
                userId: "whatsapp_" + customerWaNumber,
                userEmail: "whatsapp@coderabhi.com",
        ...
        // --- DYNAMIC MENU FEATURE ---
            ...
            let menuMessage = "🍔 *CODERABHI LIVE MENU* 🍕\n\n";
